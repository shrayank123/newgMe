...
function setup()
{
  ...
  gameimg = createSprite(600,300,30,30)
...
if(bulletsGroup.isTouching(Mon2Group))
{
  

  Mon2Group.destroyEach();
  bulletsGroup.destroyEach();
  score = score+1
...
if(score >=2 ){
  gameimg.visible=false
  spawnMon2()
  ground.addImage("ground",bg2img);
}

if(bulletsGroup.isTouching(Mon3Group))
{
  

  Mon3Group.destroyEach();
  bulletsGroup.destroyEach();
  score = score+1
...
if(bulletsGroup.isTouching(Mon4Group))
{
  

  Mon4Group.destroyEach();
  bulletsGroup.destroyEach();
  score = score+1
...
function spawnMon2() {
  ...
  if (frameCount % 90 === 0) {
    var Mon2 = createSprite(900,420,40,10);
    Mon2.y = Math.round(random(80,420));
    Mon2.addImage(mons2);
    Mon2.scale = 0.5;
    Mon2.velocityX = -3;
    Mon2.Visibility=255
...
function spawnMon3() {
  ...
  if (frameCount % 90 === 0) {
    var Mon3 = createSprite(900,420,40,10);
    Mon3.y = Math.round(random(80,420));
    Mon3.addImage(mons3);
    Mon3.scale = 0.5;
    Mon3.velocityX = -3;
    Mon3.Visibility=255
...
function spawnMon4() {
  ...
  if (frameCount % 90 === 0) {
    var Mon4 = createSprite(900,420,40,10);
    Mon4.y = Math.round(random(80,420));
    Mon4.addImage(mons4);
    Mon4.scale = 0.5;
    Mon4.velocityX = -3;
    Mon4.Visibility=255
